...
class AssetLoader {
    constructor(asset, callback) {
        ...
        this.numjsonfiles = Object.keys(this.jsons).length;
        this.totalAsset = this.numImgs + this.numSounds + this.numjsonfiles;

        console.log(`numImgs:${this.numImgs}`, `numSounds:${this.numSounds}`, `numjsonfiles:${this.numjsonfiles}`);
        // console.log()
